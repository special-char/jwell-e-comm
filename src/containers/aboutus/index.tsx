...
const About = (_props: Props) => {
    return (
        <><div className="">
            <Image src={image} alt={''} w-full h-screen/>
        </div>
                ...
                <div className="container mx-auto py-16 px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-8">
                        <div className="max-w-lg">
                            <h2 className="text-3xl font-extrabold text-white sm:text-rose-900">WELCOME TO TRISHNAS STORE!</h2>
                            ...
                            {people.map((person) => (
                                <li key={person.name}>
                                    <div className="flex items-center gap-x-6">
                                        <Image className="h-16 w-16 rounded-full" src={person.src} alt=""  width={100} height={100}/>
                                        <div>
                                            ...
                                            <div className="flex gap-2 py-2 hover:cursor-pointer">
                                                <Image src="https://www.svgrepo.com/show/303114/facebook-3-logo.svg"className="hover:scale-110" width="20" height="20" alt="fb" />
                                                <Image src="https://www.svgrepo.com/show/303115/twitter-3-logo.svg" className="hover:scale-110"width="20" height="20" alt="tw" />
                                                <Image src="https://www.svgrepo.com/show/303145/instagram-2-1-logo.svg"className="hover:scale-110" width="20" height="20" alt="inst" />
                                                <Image src="https://www.svgrepo.com/show/28145/linkedin.svg"className="hover:scale-110" width="20" height="20" alt="in" />
