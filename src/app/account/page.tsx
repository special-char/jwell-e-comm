      ...
      <div className="max-w-md w-full mx-auto relative z-50">
        ...
        <div className="border border-gray-300 bg-white rounded-md p-8">
          <form className="w-full">
            ...
            <p className="text-sm mt-6 text-center">Already have an account? <a href="javascript:void(0);" className="text-blue-600 font-semibold hover:underline ml-1">Login here</a></p>
          </form>
        </div>
      </div>
